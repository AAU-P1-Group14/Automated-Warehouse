...
#### (4) - Predefined Layout: 
Sets the layout to the default layout. This is the layout used when the program starts and is useful if you previously chose a custom layout but want to revert to the default.
