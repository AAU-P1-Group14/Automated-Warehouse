...
int dfs(int height, int width, int grid[height][width], long* direction_switches, node path[height * width],node target,node start,int* tiles,long* total_tiles,bool firstcase);
