...
int worst_case(int height, int width, int layout[height][width], long* direction_switches, node target, node dropoff, node charging, node position, long* elapsed_worst_case);
