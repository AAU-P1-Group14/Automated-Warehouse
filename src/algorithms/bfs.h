...
int bfs(int height, int width, int grid[height][width], long* direction_switches,node target_t,node current,int* tiles,long* total_tiles,node path[height * width],bool firstcase);
