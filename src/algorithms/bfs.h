...
int bfs(int height, int width, int grid[height][width], long* direction_switches,node target_t,node start,long* total_tiles,node path[height * width],bool lastcase);
